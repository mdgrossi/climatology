...
::: {.callout-note}
Note: The Daily Average reported in the statistics dashboard are DOY daily averages from @eq-ddy-d, not to be confused with @eq-tda or [-@eq-mda]. For the sake of visualization, a cosine regression is fit to these data and shown on the plots.
:::
