...
```{python}
#| content: valuebox
#| label: "Today's record low air temp"
...
```{python}
#| content: valuebox
#| label: "Today's average low air temp"
#| title: "Average Low"
record = 'Average Low'
dict(
...
```{python}
#| content: valuebox
#| label: "Today's highest low air temp"
#| title: "Highest Low"
record = 'Highest Low'
dict(
...
```{python}
#| content: valuebox
#| label: "Today's lowest high air temp"
#| title: "Lowest High"
record = 'Lowest High'
dict(
  icon = 'thermometer-half',
...
```{python}
#| content: valuebox
#| label: "Today's average high air temp"
#| title: "Average High"
record = 'Average High'
dict(
...
```{python}
#| content: valuebox
#| label: "Today's record high air temp"
#| title: "Record High"
record = 'Record High'
dict(
...
```{python}
#| content: valuebox
#| label: "Today's record low water level"
#| title: "Today's Record Low"
record = 'Record Low'
dict(
  icon = 'droplet',
...
```{python}
#| content: valuebox
#| label: "Today's average low water level"
#| title: "Average Low"
record = 'Average Low'
dict(
  icon = 'droplet-half',
...
```{python}
#| content: valuebox
#| label: "Today's highest low water level"
#| title: "Highest Low"
record = 'Highest Low'
dict(
  icon = 'moisture',
...
```{python}
#| content: valuebox
#| label: "Today's lowest high water level"
#| title: "Lowest High"
record = 'Lowest High'
dict(
  icon = 'moisture',
...
```{python}
#| content: valuebox
#| label: "Today's average high water level"
#| title: "Average High"
record = 'Average High'
dict(
  icon = 'droplet-half',
...
```{python}
#| content: valuebox
#| label: "Today's record high water level"
#| title: "Record High"
record = 'Record High'
dict(
  icon = 'droplet-fill',
...
```{python}
#| output: asis
#| label: "Yesterday's water temperature"
...
```{python}
#| content: valuebox
#| label: "Today's record low water temp"
#| title: "Today's Record Low"
record = 'Record Low'
dict(
  icon = 'thermometer-snow',
...
```{python}
#| content: valuebox
#| label: "Today's average low water temp"
#| title: "Average Low"
record = 'Average Low'
dict(
  icon = 'thermometer-low',
...
```{python}
#| content: valuebox
#| label: "Today's highest low water temp"
#| title: "Highest Low"
record = 'Highest Low'
dict(
  icon = 'thermometer-half',
...
```{python}
#| content: valuebox
#| label: "Today's lowest high water temp"
#| title: "Lowest High"
record = 'Lowest High'
dict(
  icon = 'thermometer-half',
...
```{python}
#| content: valuebox
#| label: "Today's average high water temp"
#| title: "Average High"
record = 'Average High'
dict(
  icon = 'thermometer-high',
...
```{python}
#| content: valuebox
#| label: "Today's record high water temp"
#| title: "Record High"
record = 'Record High'
dict(
  icon = 'thermometer-sun',
