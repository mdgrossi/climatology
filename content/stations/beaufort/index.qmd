...
# READ IN STATS
daily_stats = xr.load_dataset(os.path.join(HOME, dirName, 'statistics-daily.nc'))
monthly_stats = xr.load_dataset(os.path.join(HOME, dirName, 'statistics-monthly.nc'))
