...
dict(
  ...
  color = plot.colors['cb']['Record High'],
  value = plot.getval(stats=daily_stats, var=var, record='Record High')
)
```
...
dict(
  ...
  color = plot.colors['cb']['Average High'],
  value = plot.getval(stats=daily_stats, var=var, record='Average High')
)
```
...
dict(
  ...
  color = plot.colors['cb']['Lowest High'],
  value = plot.getval(daily_stats, var=var, record='Lowest High')
)
```
...
dict(
  icon = "thermometer-half",
  color = plot.colors['cb']['Highest Low'],
  value = plot.getval(daily_stats, var=var, record='Highest Low')
)
```
...
dict(
  ...
  color = plot.colors['cb']['Average Low'],
  value = plot.getval(daily_stats, var=var, record='Average Low')
)
```
...
dict(
  ...
  color = plot.colors['cb']['Record Low'],
  value = plot.getval(daily_stats, var=var, record='Record Low')
)
```
...
dict(
  icon = "droplet-fill",
  color = plot.colors['cb']['Record High'],
  value = plot.getval(stats=daily_stats, var=var, record='Record High', decimals=2)
)
```
...
dict(
  icon = "droplet-half",
  color = plot.colors['cb']['Average High'],
  value = plot.getval(stats=daily_stats, var=var, record='Average High', decimals=2)
)
```
...
dict(
  icon = "moisture",
  color = plot.colors['cb']['Lowest High'],
  value = plot.getval(daily_stats, var=var, record='Lowest High', decimals=2)
)
```
...
dict(
  icon = "moisture",
  color = plot.colors['cb']['Highest Low'],
  value = plot.getval(daily_stats, var=var, record='Highest Low', decimals=2)
)
```
...
dict(
  icon = "droplet-half",
  color = plot.colors['cb']['Average Low'],
  value = plot.getval(daily_stats, var=var, record='Average Low', decimals=2)
)
```
...
dict(
  icon = "droplet",
  color = plot.colors['cb']['Record Low'],
  value = plot.getval(daily_stats, var=var, record='Record Low', decimals=2)
)
```
